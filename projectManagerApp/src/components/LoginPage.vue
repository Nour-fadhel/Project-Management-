  ...
  <div class="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 flex items-center justify-center p-4">
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="text-center">
        ...
        <h2 class="text-2xl font-bold text-gray-900">Connectez-vous à votre compte</h2>
        <router-link to="/SignupPage">
        <p class="mt-2 text-gray-600">Ou <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500 transition-colors">créez un nouveau compte</a></p>
      </router-link>
      </div>
        ...
        <form class="space-y-6" @submit.prevent="handleLogin">
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              ...
              <a href="#" class="text-sm text-indigo-600 hover:text-indigo-500 transition-colors">Mot de passe oublié ?</a>
            </div>
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
